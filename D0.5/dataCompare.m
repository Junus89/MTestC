...
%refSp=importdata('FDSpectrum1.txt');
refSp=importdata('Subrotatingdipolespectra000.txt');
Pspec=importdata('FDPressureSpectrum.txt');
%spec=importdata('FDPressureSpectrum2omega194401fnum8192.txt');


plot(refSp(:,1),refSp(:,2),'ko','linewidth',1.5);
%stem(Pspec(:,1)-0.93,Pspec(:,2),'r','linewidth',1.3);
stem(Pspec(:,1)-0.93,Pspec(:,2),'r','linewidth',1.5);
axis([0,1500,0,0.14]);
legend('Mao et al','Predicted');
